...
import { MARKETPLACE_ADDRESS, FOOD_NFT_COLLECTION_ADDRESS } from "../../const/addresses";
...
export default function SaleInfo({ nft }: Props) {
    ...
    const { register: registerDirect, handleSubmit: handleSubmitDirect } = useForm<DirectFormData>({
        defaultValues: {
            nftContractAddress: FOOD_NFT_COLLECTION_ADDRESS,
            ...
            <TabPanels>
                <TabPanel>
                    ...
                    <Web3Button
                        ...
                        onSuccess={(txResult) => {
                            router.push(`/token/${FOOD_NFT_COLLECTION_ADDRESS}/${nft.metadata.id}`)
                        }}
